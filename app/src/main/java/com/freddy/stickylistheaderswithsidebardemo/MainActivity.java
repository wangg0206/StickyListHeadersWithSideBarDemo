...
public class MainActivity extends AppCompatActivity {
    ...
    private CityPinyinComparator comparator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comparator = new CityPinyinComparator();
        ...
        listHeadersListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toast.makeText(MainActivity.this, filterDateList.get(i).getCityName(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        et_search.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                final String text = et_search.getText().toString().trim();
                filterData(text);
            }
        });
    }
    ...
    private void filterData(String filterStr) {
        String strName = filterStr.toLowerCase();
        ...
        if (TextUtils.isEmpty(strName)) {
            ...
            for (City sortModel : cityList) {
                ...
                if (name.indexOf(strName.toString()) != -1
                        || characterParser.getSelling(name).startsWith(
                        strName.toString())||name.contains(strName)) {
